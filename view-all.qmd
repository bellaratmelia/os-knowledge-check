...
questions_list <- read_csv("data/questions.csv")
questions_list |>
  select(id, level, area) |>
  mutate(level = factor(level, levels = c("Beginner", "Intermediate", "Expert"))) |>  # sets the plotting order
  ggplot(aes(x = area, fill = level)) +
